    ...
    sap.ui.controller("sap.ovp.cards.stack.Stack", {
        ...
        onAfterRendering: function () {
            ...
            oListBinding.attachDataReceived(function () {
                ...
                var nTotalCardCount = oListBinding.getLength();
                ...
                jQuery(stackContentDomRef).attr("aria-label", sap.ui.getCore().getLibraryResourceBundle("sap.ovp").getText("stackCardContent", [nCardCount, category]));
